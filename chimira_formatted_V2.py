...
# -*- coding: utf-8 -*-
"""
Chimira formatted version 2
(PymiRa)
Created on Fri Feb 16 10:56:15 2024
...
import sys
#file_path = '/media/sf_phd_data/sequencing_test_run_0124/ngs-z.scurlock/Luz_deduplicated_trimmed_QC_full_QC.fasta'
#file_path = '/media/sf_phd_data/10000000_sequences.txt'
file_path = '/media/sf_phd_data/set2/no_rc_chimira_counts/fixed_counts/J4_S32_merged_R1_001_trimmed.4.clean_QUAL_QC_dedup_C_trimmed_3_full_QC.fasta'
...
#Import input sample
    ...
    a = time.time() - uptoalign
    print('Up to align:',time.time()-uptoalign)
    #Run the alignment
    read_counter = 0
